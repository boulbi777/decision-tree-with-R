...
#bool = require("jdfh") #this is to add require library

# Import data ---------------------------------------------------------------------------------

# Import data and create train and test data
...
# Another way to construct train/test
# test_rows <- sample.int(nrow(musch), nrow(musch) / 4)
# test <- musch[test_rows, ]
# base <- musch[-test_rows, ]
...
# cp = 0 maximal tree size can be reduced using this parameter as no split is done if the impurity
# is not reduced by at least this value
